...
<script>
  ...
  document.getElementById("cep").addEventListener("blur", async function () {
    ...
    try {
      const response = await fetch(\`${API_URL}/ws/\${cep}/json/\`);
...
export default function ExemploJavascript() {
  return (
    <div className="min-h-screen bg-[#0c0a14] text-white">
      ...
      <header className="border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center gap-3">
          ...
          <span className="text-sm text-white/50">Exemplo JavaScript</span>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-wrap gap-2 mb-12">
          {[
            { href: "/exemplo/javascript", label: "JavaScript", ativo: true },
        ...
        <p className="text-white/50 text-lg mb-10 max-w-2xl">
          Auto preenchimento de endereço via CEP usando JavaScript puro (Fetch API).
